...
public class Philosopherv5 extends Thread {
    ...
    Philosopherv5(Fork left, Fork right, Waiter waiter, int id, String csvPath) {
        this.left = left;
        this.right = right;
        this.waiter = waiter;
        this.id = id;
        this.csvFile = new File("src/main/resources/philv5/" + csvPath);
