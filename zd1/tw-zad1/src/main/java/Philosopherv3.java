...
public class Philosopherv3 extends Thread {
    private final Fork left;
    private final Fork right;
    private final int id;
    private final File csvFile;

    Philosopherv3(Fork left, Fork right, int id, String csvPath) {
        this.left = left;
        this.right = right;
        this.id = id;
        this.csvFile = new File("src/main/resources/philv3/" + csvPath);
